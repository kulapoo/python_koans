...
class AboutNone(Koan):
    ...
    def test_what_exception_do_you_get_when_calling_nonexistent_methods(self):
        ...
        """
        try:
            None.some_method_none_does_not_know_about() # type: ignore
        ...
        self.assertEqual(AttributeError, ex2.__class__) # type: ignore

        # What message was attached to the exception?
        # (HINT: replace __ with part of the error message.)
        self.assertRegex(ex2.args[0], "'NoneType' object has no attribute 'some_method_none_does_not_know_about'") # type: ignore
